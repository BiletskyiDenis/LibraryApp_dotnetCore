...
import { IBrochure } from '../interfaces/IBrochure';
import { IRecentlyItem } from '../interfaces/IRecentlyItem';
...
import { IAssetListItem } from '../interfaces/IAssetListItem';
...
export class LibraryService {
    ...
    getRecentlyAdded(type: string) {
        return this._http.get(this.host + '/api/Asset/RecentlyAdded/' + type).map(res => <IRecentlyItem[]>res.json());
    }

    getDetails(id: number) {
        return this._http.get(this.host + '/api/Asset/Details/' + id).map(res => <IDetails>res.json());
    }
    ...
    deleteAsset(id: number) {
        return this._http.delete(this.host + '/api/delete/' + id);
    }
